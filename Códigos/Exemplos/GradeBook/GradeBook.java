...
/*A Figura 7.18 contém uma classe GradeBook que utiliza um array grades bidimensional para armazenar as notas de vários
estudantes em múltiplos exames. Cada linha do array representa as notas de um único aluno para todo o curso, e cada coluna
representa as notas de todos os alunos que fizeram um exame específico. Utilizamos um array dez por três para as notas de três exames de
dez alunos*/
...
public class GradeBook
{
    ...
    public int getMinimum()
    {
        ...
        //faz uma varredura pelo array de notas
    ...
    public void outputBarChart()
    {
        ...
        //para cada nota em GradeBook, incrmenta a frequência apropriada
        for (int[] studentGrades : grades)
        {
            for (int grade : studentGrades)
            {
        ...
        {
            //gera saída do rótulo de barra ("00-09: ", ...)
            if (count == 10)
            {
